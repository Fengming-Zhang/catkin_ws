...
public:
  ...
  //-----add begin------
  unsigned int getTorquePDOBaseID();
  //-----add end--------
  void clearPose();
...
private:
  ...
  //---add begin-----
  const static unsigned int torquePDOBaseID = 0x00000480;
  const static int torquePDOIndex = 0x1803;
  const static int torquePDOMapIndex = 0x1A03;
  //---add end-------
};
