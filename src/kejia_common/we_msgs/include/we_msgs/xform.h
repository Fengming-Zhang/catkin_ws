...
#define PEEK_CMD_FFFD(cmd, s, n, f1, f2, f3, d) \
        (strncmp(cmd, s, n) == 0 && sscanf(cmd + n, "%f %f %f %d", &f1, &f2, &f3, &d) == 4)
#define PEEK_CMD_FFFS(cmd, s, n, f1, f2, f3, str) \
        (strncmp(cmd, s, n) == 0 && sscanf(cmd + n, "%f %f %f %s", &f1, &f2, &f3, &str) == 4)
